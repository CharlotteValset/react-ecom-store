    ...
    <>
      ...
      <div className="mx-auto w-5/6 max-w-7xl">
        <div className="flex flex-col md:justify-center mt-6 md:flex-row">
          ...
          <div className="py-5 md:pt-0 md:w-2/4 md:ms-12">
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Smartwatch</h5>
            ...
            <div className="flex items-center mt-2.5 mb-5">
              <div className="flex items-center space-x-1 rtl:space-x-reverse">
                <svg
                  className="w-4 h-4 text-purple-pink"
                  aria-hidden="true"
